...
void Initialiser(char tableau[3][3]); // Prototype de l'initialisation du jeu : rempli et affiche le tableau. Utile pour les nouvelles parties.
...
void JeuOrdinateur(char tableau[3][3],char pionOrdinateur); // Prototype du jeu ordinateur mode aléatoire.
void ModeOffensif(char tableau[3][3],char pionOrdinateur,char pionJoueur); // Prototype du mode offensif. Prend les deux pions en param pour les vérifs
void ModeDefensif(char tableau[3][3],char pionOrdinateur,char pionJoueur);// Prototype du mode defensif. Prend les deux pions en param pour les vérifs
void PremierJoueur(char &pionOrdinateur,char &pionJoueur); // Prototype de la définition du premier joueur : determine quel joueur à les 'X' et passe les résultats par valeur.
void JouerOffensif(char tableau[3][3], char pionOrdinateur, char pionJoueur);// Prototype du mode offensif. Prend les deux pions en param pour les vérifs
void JouerDefensif(char tableau[3][3], char pionOrdinateur, char pionJoueur);//Prototype du mode defensif. Prend les deux pions en param pour les vérifs
void Jouer(char tableau[3][3], char pionOrdinateur, char pionJoueur); // le jeu tout simplement. Prend les pions en paramêtre pour faire jouer le joueur ou L'ordi.
// void CoupsRestants(char tableau[2][2]); // std string ne reconnait pas la méthode to_string, pour pouvoir assigner les indices du morpion dans une case tableau ... j'ai laissé un random mais qui fonctionne bien.
bool IsGagne(char tableau[3][3],char pionJoueur,char pionOrdinateur); // Prototype du test si le jeu est gagné ou non. prend les pions en param pour les vérifs.Bool qui renvoie true si le jeu est fini.

int main(){
setlocale(LC_ALL, ""); // pour pouvoir parametrer la console en utf-8
int choix;
...
cin>>choix;
char tableau[3][3], pionOrdinateur='a',pionJoueur='b'; // on assigne une valeur de base pour les pions pour éviter le bug.
switch(choix){
